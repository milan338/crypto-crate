// Adapted from https://github.com/pmndrs/drei/blob/master/src/core/meshBounds.tsx
...
export function meshBounds(this: any, raycaster: Raycaster, intersects: Intersection[]) {
